 ...
 */
/*
use \Kwpanorama\KWPPath;
use \Kwpanorama\KWPFolder;
use \Kwpanorama\KWPFile;
*/
...
use stdClass;
//use Joomla\Component\Kwpanorama\Administrator\View\Browse;
...
class KwpbrowseHelper {
	...
	public static function getItemsList($type = 'image') {
		...
		$folder = $input->get('folder', '', 'string') ? '/' . trim($input->get('folder', '', 'string'), '/') : '/' . trim(ComponentHelper::getParams('com_kwpanorama')->get('imagespath', 'images/kwpanorama'), '/');
		...
		// no folder filtering 
		if (ComponentHelper::getParams('com_kwpanorama')->get('imagespathexclusive', '0') == '0') {
	...
	public static function ajaxAddPicture() {
		...
		$imgpath = $input->get('path', '', 'string') ? '/' . trim($input->get('path', '', 'string'), '/') . '/' : '/' . trim(ComponentHelper::getParams('com_kwpanorama')->get('imagespath', 'images/kwpanorama'), '/') . '/';
