...
namespace Joomla\Component\Kwpanorama\Administrator\Table;
...
class KwpanoramaTable extends Table
{
    /**
    ...
    {
        parent::__construct('#__kwpanorama', 'id', $db);
    }
    ...
    public function bind($data, $ignore = '')
    {
        ...
        if(($task == 'save' || $task == 'apply') && (!Factory::getUser()->authorise('core.edit.state','com_kwpanorama') && !isset($data['id']))) {
            $data['state'] = 0;
        }
     ...
     /*
        ...
        if(!Factory::getUser()->authorise('core.admin', 'com_kwpanorama.kwpanorama.'.$data['id']))
        {
            $actions = ContentHelper::getActions('com_kwpanorama','kwpanorama');
            $defaultActions = Access::getAssetRules('com_kwpanorama.kwpanorama.'.$data['id'])->getData();
            $jaccessRules = [];
    ...
    {
        $k = $this->_tbl_key;
        return 'com_kwpanorama.kwpanorama.' . (int) $this->$k;
    }
    ...
    protected function _getAssetParentId(Table $table = NULL, $id = NULL) : int
    {
        ...
        $assetParent->loadByName('com_kwpanorama');
