...
.canvas-container {
  margin: auto;
  animation: rotate ".$params->animspeed."s infinite ease-in-out alternate;
  position: relative;
  transform-style: preserve-3d;
}

";
$wa->addInlineStyle($anim);
...
$wa->registerAndUseScript('threedimensions',Uri::Base().'components/com_kwpanorama/assets/js/threedimensions.js' );
     ...
     $forcomponent = "		
		...
		bq('.borggique').borg.config({ width:'".$params->image_width."', height:'".$params->image_height."',  cubespeed:'".$params->animspeed."',
	...
	bq.fn.borg.defaults.cubespeed=8;	
