...
namespace Joomla\Component\Kwpanorama\Site\View\Kwpanorama;
...
class HtmlView extends BaseHtmlView
{
    ...
    public function display($tpl = null): void
    {
        ...
        $this->params 				= $app->getParams('com_kwpanorama');
    ...
    private function hasAccess(): bool
    {
        ...
        if($this->_layout == 'edit') {
            ...
            if ($isEdit) {
                $authorised = $user->authorise('core.edit', 'com_kwpanorama');
                $access = new AccessHelper();
                $access->preloadOwnRecords('#__kwpanorama_kwpanoramas');
                if ($access->canAccessOwnRecord()) {
                    return true;
                }
            } else {
                $authorised = $user->authorise('core.create', 'com_kwpanorama');
            }
            if ($authorised !== true) {
    ...
    protected function setupDocument(): void
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', Text::_('COM_KWPANORAMA_DEFAULT_PAGE_TITLE'));
        }
