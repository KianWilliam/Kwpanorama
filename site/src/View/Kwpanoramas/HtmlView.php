...
namespace Joomla\Component\Kwpanorama\Site\View\Kwpanoramas;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
        ...
        $this->authorised = [
            'create' => $user->authorise('core.create', 'com_kwpanorama'),
            'edit' => $user->authorise('core.edit', 'com_kwpanorama')
        ];
